...
from model.modeling import make_model

from model.engine import build_engine
from model.utils.scheduler import ParamScheduler, sigmoid_anneal
...
def main():
    ...
    parser.add_argument(
        "--config_file",
        default="configs\gtppo_tr_JAAD.yml",
        metavar="FILE",
    ...
    cfg.merge_from_list(['VISUALIZE','False','USE_WANDB','True'])
    ...
    for epoch in tqdm(range(cfg.SOLVER.MAX_EPOCH)):
